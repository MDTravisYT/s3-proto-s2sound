Sound43_EnterGiantRing_Header:
	...
	smpsHeaderSFXChannel cFM4, Sound43_EnterGiantRing_FM4,	$0C, $00
	smpsHeaderSFXChannel cFM5, Sound43_EnterGiantRing_FM5,	$00, $13

; FM4 Data
Sound43_EnterGiantRing_FM4:
	smpsSetvoice        $01
	dc.b	nRst, $01, nA2, $08
	smpsSetvoice        $00
...
; FM5 Data
Sound43_EnterGiantRing_FM5:
	smpsSetvoice        $02
	smpsModSet          $06, $01, $03, $FF
	dc.b	nRst, $0A

Sound43_EnterGiantRing_Loop00:
	dc.b	nFs5, $06
	smpsLoop            $00, $05, Sound43_EnterGiantRing_Loop00
	dc.b	nFs5, $17
	smpsStop

Sound43_EnterGiantRing_Voices:
;	Voice $00
;	$30
