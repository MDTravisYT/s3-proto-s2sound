Sound26_HurtBySpikes_Header:
	smpsHeaderStartSong 3
	smpsHeaderVoice     Sound26_HurtBySpikes_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $01

	smpsHeaderSFXChannel cFM5, Sound26_HurtBySpikes_FM5,	$F2, $00

; FM5 Data
Sound26_HurtBySpikes_FM5:
	smpsSetvoice        $00
	smpsModSet          $01, $01, $10, $FF
	dc.b	nFs6, $05, nD7, $25
	smpsStop

Sound26_HurtBySpikes_Voices:
;	Voice $00
;	$3B
